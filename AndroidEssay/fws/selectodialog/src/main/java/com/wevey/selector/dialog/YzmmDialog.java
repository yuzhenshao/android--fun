...
public class YzmmDialog {
    ...
    public YzmmDialog(Builder builder) {
        ...
        mLeftBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mBuilder.getOnclickListener() != null) {
                    ...
                    mBuilder.getOnclickListener().clickLeftButton(YzmmDialog.this, mLeftBtn);
                }
            }
        });
        mRightBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mBuilder.getOnclickListener() != null) {
                    ...
                    mBuilder.getOnclickListener().clickRightButton(YzmmDialog.this,
                            mRightBtn,mContent);
                }
    ...
    public static class Builder {
        ...
        private DialogInterface.OnLeftAndRightClick2Listener<YzmmDialog> onclickListener;
        ...
        public DialogInterface.OnLeftAndRightClick2Listener<YzmmDialog> getOnclickListener() {
            return onclickListener;
        }

        public Builder setOnclickListener(DialogInterface.OnLeftAndRightClick2Listener<YzmmDialog> onclickListener) {
        ...
        public YzmmDialog build() {

            return new YzmmDialog(this);
        }
    }
