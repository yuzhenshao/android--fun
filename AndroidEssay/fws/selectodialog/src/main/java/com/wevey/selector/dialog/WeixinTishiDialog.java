 ...
 */
public class WeixinTishiDialog {
    ...
    public WeixinTishiDialog(Builder builder) {

        this.mBuilder = builder;
        mDialog = new Dialog(mBuilder.getContext(), R.style.NormalDialogStyle);
        mDialogView = View.inflate(mBuilder.getContext(), R.layout.weixin_tishi_dialog, null);
...
//        mDialog.setCanceledOnTouchOutside(builder.isTouchOutside());
        ...
        dialog_normal_rightbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mBuilder.getOnclickListener() != null) {
                    ...
                    mBuilder.getOnclickListener().clickRightButton(WeixinTishiDialog.this,
        ...
        dialog_normal_leftbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mBuilder.getOnclickListener() != null) {
                    ...
                    mBuilder.getOnclickListener().clickLeftButton(WeixinTishiDialog.this,
    ...
    public static class Builder {
        ...
        private DialogInterface.OnLeftAndRightClickListener<WeixinTishiDialog> onclickListener;
        private DialogInterface.OnSingleClickListener<WeixinTishiDialog> singleListener;
        ...
        public DialogInterface.OnSingleClickListener<WeixinTishiDialog> getSingleListener() {
            return singleListener;
        }

        public Builder setSingleListener(DialogInterface.OnSingleClickListener<WeixinTishiDialog>
                                                 singleListener) {
            this.singleListener = singleListener;
            return this;
        }

        public DialogInterface.OnLeftAndRightClickListener<WeixinTishiDialog> getOnclickListener() {
            return onclickListener;
        }

        public Builder setOnclickListener(DialogInterface.OnLeftAndRightClickListener<WeixinTishiDialog>
                                                  onclickListener) {
        ...
        public WeixinTishiDialog build() {

            return new WeixinTishiDialog(this);
        }
    }
