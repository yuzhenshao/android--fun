...
public class RegisterPwdActivity extends BaseMvpActivity<RegistPwdPresent> {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        etRegiPwd.setOnFocusChangeListener(new android.view.View.OnFocusChangeListener() {
            @Override
        ...
        etRegiPwd2.setOnFocusChangeListener(new android.view.View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {// 获得焦点
