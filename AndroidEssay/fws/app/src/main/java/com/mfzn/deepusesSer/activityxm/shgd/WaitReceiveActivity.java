    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.but_accept:
                Intent intent = new Intent(WaitReceiveActivity.this,JiedanHuizhiActivity.class);
    ...
    public void onClickPopIcon(View view) {
        ...
        dropPopMenu.setOnItemClickListener(new DropPopMenu.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id, MenuItem menuItem) {
                startActivity(new Intent(WaitReceiveActivity.this, EditWorkorderActivity.class));
            }
        });
