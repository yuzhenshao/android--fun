...
public class SettingNewsPwdActivity extends BaseMvpActivity<ExchangePswPresent> {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        etNewsPwd.setOnFocusChangeListener(new android.view.View.OnFocusChangeListener() {
            @Override
        ...
        etNewsPwd2.setOnFocusChangeListener(new android.view.View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {// 获得焦点
