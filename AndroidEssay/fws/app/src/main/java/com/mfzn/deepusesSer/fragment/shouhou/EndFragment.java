...
import com.mfzn.deepusesSer.present.shouhou.EndPresnet;
...
public class EndFragment extends BaseMvpFragment<EndPresnet> {
    ...
    @Override
    public EndPresnet newP() {
        return new EndPresnet();
    }
    ...
    public void onResume() {
        ...
        adapter.clearData();
        pages = 1;
        getP().workorderList(pages,"6", XiangmuFragment.shType);
    }
    public void refreshData(String shType){
        adapter.clearData();
        pages = 1;
        getP().workorderList(pages,"6", shType);
    }
