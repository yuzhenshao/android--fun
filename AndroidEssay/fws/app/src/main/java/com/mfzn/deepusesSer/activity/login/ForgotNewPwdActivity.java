...
public class ForgotNewPwdActivity extends BaseMvpActivity<ForgotPwdPresent> {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        etForPwd.setOnFocusChangeListener(new android.view.View.OnFocusChangeListener() {
            @Override
        ...
        etForPwd2.setOnFocusChangeListener(new android.view.View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {// 获得焦点
