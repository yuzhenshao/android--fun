...
import com.mfzn.deepusesSer.activityxm.shgd.JiedanHuizhiActivity;
...
public class JiedanHuizhiPresnet extends XPresent<JiedanHuizhiActivity> {
        ...
        ApiHelper.getApiService().jiedan(UserHelper.getToken(), UserHelper.getUid(),request)
                ...
                .subscribe(new ApiSubscriber<HttpResult>() {
                    ...
                    public void onNext(HttpResult result) {
                        getV().jiedanHuizhiResult(result);
                    }
                });
    }
}
