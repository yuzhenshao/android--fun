package com.mfzn.deepusesSer.x5webview;
...
public class ProgressView extends View {
    int defaultColor = R.color.real_agree;
    ...
    private void init() {
        ...
        progressPaint.setColor(getResources().getColor(defaultColor));
        progressCircle = new Paint();
        progressCircle.setColor(getResources().getColor(defaultColor));
