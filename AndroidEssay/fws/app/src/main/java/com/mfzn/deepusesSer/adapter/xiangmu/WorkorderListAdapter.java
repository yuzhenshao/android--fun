...
public class WorkorderListAdapter extends RecyclerAdapter<WorkorderListModel.DataBean, WorkorderListAdapter.MsgBusinessHolder> {
    ...
    public MsgBusinessHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_workorder_list, parent, false);
