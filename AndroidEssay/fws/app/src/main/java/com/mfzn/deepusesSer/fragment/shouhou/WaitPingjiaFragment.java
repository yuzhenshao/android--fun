...
import com.mfzn.deepusesSer.present.shouhou.WaitPingjiaPresnet;
...
public class WaitPingjiaFragment extends BaseMvpFragment<WaitPingjiaPresnet> {
    ...
    @Override
    public WaitPingjiaPresnet newP() {
        return new WaitPingjiaPresnet();
    }
    ...
    public void onResume() {
        ...
        adapter.clearData();
        pages = 1;
        getP().workorderList(pages,"5", XiangmuFragment.shType);
    }
    public void refreshData(String shType){
        adapter.clearData();
        pages = 1;
        getP().workorderList(pages,"5", shType);
    }
