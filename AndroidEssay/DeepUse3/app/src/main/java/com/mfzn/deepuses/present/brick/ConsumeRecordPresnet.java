...
public class ConsumeRecordPresnet extends XPresent<ConsumeRecordFragment> {

    public void transactionRecord(Integer page) {
        ApiHelper.getApiService().transactionRecord(UserHelper.getToken(), UserHelper.getUid(),UserHelper.getCompanyId(),"2","10",page)
