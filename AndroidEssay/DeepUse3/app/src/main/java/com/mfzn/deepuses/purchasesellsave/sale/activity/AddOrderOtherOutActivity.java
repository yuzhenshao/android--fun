...
public class AddOrderOtherOutActivity extends BasicActivity {
    ...
    public void viewClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.customer_select:
                intent.setClass(AddOrderOtherOutActivity.this, MyCustomerActivity.class);
                startActivityForResult(intent, USER);
                break;
            case R.id.goods_select:
                intent.setClass(AddOrderOtherOutActivity.this, GoodsSelectListActivity.class);
                startActivityForResult(intent, GOODS);
                break;
            case R.id.other_cost_select:
                intent.setClass(AddOrderOtherOutActivity.this, SetCostActivity.class);
            ...
            case R.id.store_select:
                intent.setClass(AddOrderOtherOutActivity.this, StoreListActivity.class);
                startActivityForResult(intent, USER);
                break;
