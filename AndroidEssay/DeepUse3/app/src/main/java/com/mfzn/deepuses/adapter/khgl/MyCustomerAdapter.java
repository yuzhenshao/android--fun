...
public class MyCustomerAdapter extends RecyclerAdapter<WholeCustomerModel.DataBean, MyCustomerAdapter.MsgBusinessHolder> {
    ...
    public MsgBusinessHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_my_customer, parent, false);
