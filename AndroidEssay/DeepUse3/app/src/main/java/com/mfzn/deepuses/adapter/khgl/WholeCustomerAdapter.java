...
public class WholeCustomerAdapter extends RecyclerAdapter<WholeCustomerModel.DataBean, WholeCustomerAdapter.MsgBusinessHolder> {
    ...
    public MsgBusinessHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_whole_customer, parent, false);
    ...
    public void onBindViewHolder(MsgBusinessHolder holder, int position) {
        ...
        holder.tv_cus_item_del.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
