...
public class SearchCustomerActivity extends BaseMvpActivity<SearchCustomerPresnet> {
    ...
    @Override
    public SearchCustomerPresnet newP() {
        return new SearchCustomerPresnet();
    }
    ...
    public void brickRecordSuccess(WholeCustomerModel models) {
        ...
        seListview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(SearchCustomerActivity.this, CustomerDetailsActivity.class);
        ...
        adapter.setOnPhoneItemClickListener(new SearchCustomerAdapter.OnPhoneItemClickListener() {
            ...
            public void onItemClick(View view, String phone) {
                PhoneUtils.dialogPhone2(SearchCustomerActivity.this, "拨打",phone,phone);
            }
        });
    }
}
