...
public class SelectCustomer2Adapter extends RecyclerAdapter<WholeCustomerModel.DataBean, SelectCustomer2Adapter.MsgBusinessHolder> {

    private OnRecyclerViewItemClickListener mOnItemClickListener = null;

    public SelectCustomer2Adapter(Context context) {
        super(context);
    }

    @Override
    public MsgBusinessHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_select_customer2, parent, false);
