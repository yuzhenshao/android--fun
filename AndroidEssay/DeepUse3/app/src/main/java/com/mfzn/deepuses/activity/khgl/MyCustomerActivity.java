...
import com.mfzn.deepuses.present.customer.MyCustomerDetailsPresnet;
...
public class MyCustomerActivity extends BaseMvpActivity<MyCustomerPresnet> {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        tvBassTitle.setText("我的客户");

        adapter = new MyCustomerAdapter(getContext());
        ...
        adapter.setOnItemClickListener(new MyCustomerAdapter.OnRecyclerViewItemClickListener() {
            @Override
        ...
        adapter.setOnPhoneItemClickListener(new MyCustomerAdapter.OnPhoneItemClickListener() {
            @Override
            public void onItemClick(View view, String phone) {
                PhoneUtils.dialogPhone2(MyCustomerActivity.this, "拨打",phone,phone);
            }
        });
        adapter.setOnDelItemClickListener(new MyCustomerAdapter.OnDelItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                positions = position;
...
//                startActivity(new Intent(this, SelectTypeActivity.class));
            ...
            case R.id.et_cus_search:
                startActivity(new Intent(this, SearchMyCustomerActivity.class));
                break;
            case R.id.iv_add:
