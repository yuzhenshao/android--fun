...
public class RechargeBrickFragment extends BaseMvpFragment<RechargeBrickPresnet> {
    ...
    public int getLayoutId() {
        return R.layout.fragment_recharge_brick;
    }

    @Override
    public RechargeBrickPresnet newP() {
        return new RechargeBrickPresnet();
    }
