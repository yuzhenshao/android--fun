...
public class News implements Serializable {
    ...
    public static class DataBean implements Serializable {
        ...
        private List<NewsListRequest.CmsLabelsBean> cmsLabels;
        ...
        public List<NewsListRequest.CmsLabelsBean> getCmsLabels() {
            return cmsLabels;
        }

        public void setCmsLabels(List<NewsListRequest.CmsLabelsBean> cmsLabels) {
