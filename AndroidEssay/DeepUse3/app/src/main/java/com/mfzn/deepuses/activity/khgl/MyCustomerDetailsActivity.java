...
import com.mfzn.deepuses.fragment.khxq.BasicInfo2Fragment;
...
public class MyCustomerDetailsActivity extends BaseMvpActivity<MyCustomerDetailsPresnet> {
    ...
    public int getLayoutId() {
        return R.layout.activity_my_customer_details;
    }

    @Override
    public MyCustomerDetailsPresnet newP() {
        return new MyCustomerDetailsPresnet();
    }
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        BasicInfo2Fragment basicInfoFragment = new BasicInfo2Fragment();
