...
package com.mfzn.deepuses.zxings.camera;
...
/**
 * This payclass is used to activate the weak light on some camera phones (not flash)
 ...
 * Thanks to Ryan Alford for pointing out the availability of this payclass.
 */
final class FlashlightManager {
  ...
  private static Class<?> maybeForName(String name) {
    try {
      ...
      Log.w(TAG, "Unexpected error while finding payclass " + name, re);
      return null;
    }
  }
