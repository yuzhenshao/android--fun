...
public class SelectKhztAdapter extends RecyclerView.Adapter {

    private Context context;
    private List<SelectModel.FollowStatusBean> others;
    /**
     * 以后用它来初始化布局
     */
    ...
    public SelectKhztAdapter(Context mContext, List<SelectModel.FollowStatusBean> others) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MoreViewHolder(context, mLayoutInflater.inflate(R.layout.recyleview_select_khzt, null));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        SelectModel.FollowStatusBean othersBean = others.get(position);

        bbnViewHolder.tv_iten_bane.setText(othersBean.getName());
