...
public class RechargeBrickAdapter extends RecyclerAdapter<BrickRecordModel.FinancialLogBean.DataBean, RechargeBrickAdapter.MsgBusinessHolder> {

    private OnRecyclerViewItemClickListener mOnItemClickListener = null;

    public RechargeBrickAdapter(Context context) {
        super(context);
    }

    @Override
    public MsgBusinessHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_recharge_brick, parent, false);
    ...
    public void onBindViewHolder(MsgBusinessHolder holder, int position) {
        ...
        BrickRecordModel.FinancialLogBean.DataBean model = data.get(position);
