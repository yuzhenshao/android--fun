...
public class AlreadyCloseActivity extends BaseMvpActivity<AlreadyClosePresent> {
    ...
    @BindView(R.id.tv_close_typename)
    TextView tvcloseTypename;
    @BindView(R.id.tv_close_address)
    TextView tvcloseAddress;
    @BindView(R.id.tv_close_name)
    ...
    @Override
    public AlreadyClosePresent newP() {
        return new AlreadyClosePresent();
    }
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        tvcloseTypename.getPaint().setFakeBoldText(true);
        ...
        tvcloseAddress.setText(dataBean.getDetailAddress());
        tvcloseName.setText(dataBean.getContactName());
        contactPhone = dataBean.getContactPhone();
        tvclosePhone.setText(contactPhone);
