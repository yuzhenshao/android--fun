...
public class ConsumeBrickAdapter extends RecyclerAdapter<BrickRecordModel.FinancialLogBean.DataBean, ConsumeBrickAdapter.MsgBusinessHolder> {

    private OnRecyclerViewItemClickListener mOnItemClickListener = null;

    public ConsumeBrickAdapter(Context context) {
        super(context);
    }

    @Override
    public MsgBusinessHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_consume_brick, parent, false);
