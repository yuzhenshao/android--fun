...
public class MoneyAccountAdapter extends BaseQuickAdapter<MoneyAccountListResponse.AccountResponse, BaseViewHolder> {
    public MoneyAccountAdapter(@Nullable List<MoneyAccountListResponse.AccountResponse> data) {
        super(R.layout.money_account_item_view, data);
    }
