...
public class SalesOrderOfferFilterActivity extends BasicActivity {
    ...
    private void initData() {
        ...
        orderType=getIntent().getIntExtra(ParameterConstant.ORDER_TYPE,3);


        List<FilterModule> orderTypeFilterModules = new ArrayList<>();
        orderTypeFilterModules.add(new FilterModule(3, "报价单"));
        orderTypeFilterModules.add(new FilterModule(4, "销售订单"));
        orderTypeFilterModules.add(new FilterModule(5, "零售单"));
        orderTypeFilterModules.add(new FilterModule(6, "销售退货单"));
        orderTypeFilterModules.add(new FilterModule(13, "零售退货单"));
        orderTypeFilterModules.add(new FilterModule(7, "个人领货单"));
        orderTypeFilterModules.add(new FilterModule(8, "个人归还单"));
