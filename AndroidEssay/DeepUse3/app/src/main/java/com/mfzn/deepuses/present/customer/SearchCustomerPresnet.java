...
public class SearchCustomerPresnet extends XPresent<SearchCustomerActivity> {
    ...
    public void wholeCustomer(Integer page,String keywords, String customerLevelID, String followStatusID, String hasFollowRecords) {
        ApiHelper.getApiService().wholeCustomer(UserHelper.getToken(), UserHelper.getUid(),UserHelper.getCompanyId(),"100",page,
