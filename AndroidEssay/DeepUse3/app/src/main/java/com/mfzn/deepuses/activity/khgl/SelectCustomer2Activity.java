...
import com.mfzn.deepuses.present.customer.SelectCustomer2Presnet;
...
public class SelectCustomer2Activity extends BaseMvpActivity<SelectCustomer2Presnet> {
    ...
    public int getLayoutId() {
        return R.layout.activity_select_customer2;
    }

    @Override
    public SelectCustomer2Presnet newP() {
        return new SelectCustomer2Presnet();
    }
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        adapter.setOnItemClickListener(new SelectCustomerAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                intent.putExtra(Constants.CREAT_ID, String.valueOf(dataBean.getUid()));
