...
public class StoreCheckGoodsAdapter extends BaseQuickAdapter<StoreCheckGoodsResponse, BaseViewHolder> {

    protected Context context;

    public StoreCheckGoodsAdapter(Context context, @Nullable List<StoreCheckGoodsResponse> data) {
        super(R.layout.stock_check_goods_item_view, data);
        this.context = context;
    }

    @Override
    protected void convert(BaseViewHolder helper, StoreCheckGoodsResponse item) {
