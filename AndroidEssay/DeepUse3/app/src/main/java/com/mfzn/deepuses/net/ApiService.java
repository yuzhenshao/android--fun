...
//为不同用户生成推广二维码
    ...
    @GET("api/after_sale/lookAsOrder")//查看工单信息
    ...
    @GET("api/after_sale/lookAsOrderProcess")//查看处理过程
