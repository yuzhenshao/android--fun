...
//查看回单信息
    ...
    @FormUrlEncoded
    @POST("pss/Setting/goodsUnitList")
    ...
    Flowable<HttpResult> orderStockCheckDelBatch(@Query("token") String token, @Query("uid") String uid, @Query("shopID") String shopID, @Query("orderIDs") String orderIDs);
