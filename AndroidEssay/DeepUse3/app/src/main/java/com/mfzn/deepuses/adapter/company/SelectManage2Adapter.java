...
public class SelectManage2Adapter extends BaseAdapter {

    private Context mContext;
    private List<ZuzhiJiagouModel.SonsBeanX.StaffBeanX> list;

    public SelectManage2Adapter(Context context, List<ZuzhiJiagouModel.SonsBeanX.StaffBeanX> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.listview_select_manage2, null);
