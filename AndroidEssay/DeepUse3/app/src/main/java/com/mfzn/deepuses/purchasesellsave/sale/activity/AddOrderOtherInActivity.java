...
public class AddOrderOtherInActivity extends BasicActivity {
    ...
    public void viewClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.customer_select:
                intent.setClass(AddOrderOtherInActivity.this, MyCustomerActivity.class);
                startActivityForResult(intent, USER);
                break;
            case R.id.goods_select:
                intent.setClass(AddOrderOtherInActivity.this, GoodsSelectListActivity.class);
                startActivityForResult(intent, GOODS);
                break;
            case R.id.other_cost_select:
                intent.setClass(AddOrderOtherInActivity.this, SetCostActivity.class);
            ...
            case R.id.store_select:
                intent.setClass(AddOrderOtherInActivity.this, StoreListActivity.class);
                startActivityForResult(intent, USER);
                break;
