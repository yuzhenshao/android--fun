...
public class MyCustomerPresnet extends XPresent<MyCustomerActivity> {
    ...
    public void wholeCustomer(Integer page,String keywords, String customerLevelID, String followStatusID, String hasFollowRecords) {
        ApiHelper.getApiService().myCustomer(UserHelper.getToken(), UserHelper.getUid(),UserHelper.getCompanyId(),"10",page,
    ...
    public void delCustomer(String customerID) {
        ApiHelper.getApiService().fangCustomer(UserHelper.getToken(), UserHelper.getUid(),UserHelper.getCompanyId(),customerID)
                .compose(XApi.getApiTransformer())
                .compose(XApi.getScheduler())
                .compose(getV().bindToLifecycle())
