...
import com.mfzn.deepuses.present.customer.CustomerTongjiPresnet;
...
public class CustomerTongjiFragment extends BaseMvpFragment<CustomerTongjiPresnet> {
...
//
//    private RechargeBrickAdapter adapter;
//    private int pages = 1;

    @Override
    public int getLayoutId() {
        return R.layout.fragment_customer_tongji;
    }

    @Override
    public CustomerTongjiPresnet newP() {
        return new CustomerTongjiPresnet();
    }

    @Override
    public void initData(Bundle savedInstanceState) {

//        adapter = new RechargeBrickAdapter(getContext());
