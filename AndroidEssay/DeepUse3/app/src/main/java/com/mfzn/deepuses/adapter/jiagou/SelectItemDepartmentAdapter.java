...
public class SelectItemDepartmentAdapter extends BaseAdapter {
    ...
    private List<ZuzhiJiagouModel.SonsBean> beanXES;

    private OnItemClickLisenter onItemClickLisenter;

    public SelectItemDepartmentAdapter(Context context, List<ZuzhiJiagouModel.SonsBean> sons, List<ZuzhiJiagouModel.SonsBean> beanXES) {
