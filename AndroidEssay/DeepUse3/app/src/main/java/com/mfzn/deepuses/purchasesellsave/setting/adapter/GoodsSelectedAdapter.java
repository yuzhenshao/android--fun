...
public class GoodsSelectedAdapter extends BaseQuickAdapter<CommodityRequest, BaseViewHolder> {

    protected Context context;

    public GoodsSelectedAdapter(Context context, @Nullable List<CommodityRequest> data) {
