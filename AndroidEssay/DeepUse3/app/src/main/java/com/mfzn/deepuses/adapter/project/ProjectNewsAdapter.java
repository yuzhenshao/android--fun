...
public class ProjectNewsAdapter extends RecyclerAdapter<ProjectNewsModel.DataBean, ProjectNewsAdapter.MsgBusinessHolder> {
    ...
    public MsgBusinessHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_project_news, parent, false);
    ...
    public void onBindViewHolder(MsgBusinessHolder holder, int position) {
        ...
        ProjectNewsModel.DataBean bean = data.get(position);
        ...
        holder.tvPrItemName.setText(bean.getU_name());
        holder.tvPrItemJoin.setText(bean.getPro_name());
        holder.tvPrItemXx.setText(bean.getLabelName());
