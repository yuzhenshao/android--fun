...
public class ManageJiagou3Adapter extends BaseAdapter {

    private Context mContext;
    private List<ZuzhiJiagouModel.SonsBeanX.SonsBean.StaffBean> list;
    private int type;

    public ManageJiagou3Adapter(Context context, List<ZuzhiJiagouModel.SonsBeanX.SonsBean.StaffBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.listview_manage_jiagou3, null);
