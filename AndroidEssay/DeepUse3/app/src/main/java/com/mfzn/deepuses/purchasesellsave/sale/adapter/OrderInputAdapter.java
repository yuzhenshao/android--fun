...
public class OrderInputAdapter extends BaseQuickAdapter<OrderSalesListResponse.OrderSalesResponse, BaseViewHolder> {

    protected Context context;

    public OrderInputAdapter(Context context, @Nullable List<OrderSalesListResponse.OrderSalesResponse> data) {
        super(R.layout.order_offer_item, data);
        this.context = context;
    }

    @Override
    protected void convert(BaseViewHolder helper, OrderSalesListResponse.OrderSalesResponse item) {
