...
public class BaseArchivesActivity extends BasicActivity {
    ...
    private void initData() {
        ...
        mSourceList.add(new ModuleItem("商品", "创建商品数据", R.mipmap.icon_commodity, GoodsListActivity.class));
        ...
        mSourceList.add(new ModuleItem("其他费用", "创建单据时除了商品费用外的其他费用，如安装费", R.mipmap.icon_cost, OtherCostActivity.class));
        mSourceList.add(new ModuleItem("收支类别", "财务记账时的其他收入与支出类别，如租金，水电", R.mipmap.icon_income_categories, IncomeExpenseActivity.class));
