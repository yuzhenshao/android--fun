...
public class HomeKhglAdapter extends RecyclerView.Adapter {
    ...
    public HomeKhglAdapter(Context mContext, List<HomeShowModel> others) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MoreViewHolder(context, mLayoutInflater.inflate(R.layout.recyleview_home_khgl, null));
    }
