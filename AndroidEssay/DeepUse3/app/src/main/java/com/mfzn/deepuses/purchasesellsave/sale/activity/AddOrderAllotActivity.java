...
public class AddOrderAllotActivity extends BasicActivity {
    ...
    public void viewClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.customer_select:
                intent.setClass(AddOrderAllotActivity.this, MyCustomerActivity.class);
                startActivityForResult(intent, USER);
                break;
            case R.id.goods_select:
                intent.setClass(AddOrderAllotActivity.this, GoodsSelectListActivity.class);
                startActivityForResult(intent, GOODS);
                break;
            case R.id.other_cost_select:
                intent.setClass(AddOrderAllotActivity.this, SetCostActivity.class);
