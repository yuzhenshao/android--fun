...
public class WholeBrickAdapter extends RecyclerAdapter<BrickRecordModel.FinancialLogBean.DataBean, WholeBrickAdapter.MsgBusinessHolder> {

    private OnRecyclerViewItemClickListener mOnItemClickListener = null;

    public WholeBrickAdapter(Context context) {
        super(context);
    }
