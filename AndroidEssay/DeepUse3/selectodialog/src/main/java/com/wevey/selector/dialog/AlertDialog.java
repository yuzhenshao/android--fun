...
public class AlertDialog {
    ...
    public AlertDialog(Builder builder) {
        ...
        mDialogView = View.inflate(mBuilder.getContext(), R.layout.widget_dialog_alert, null);
        ...
        mLeftBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mBuilder.getOnclickListener() != null) {
                    ...
                    mBuilder.getOnclickListener().clickLeftButton(AlertDialog.this, mLeftBtn);
                }
            }
        });
        mRightBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mBuilder.getOnclickListener() != null) {
                    ...
                    mBuilder.getOnclickListener().clickRightButton(AlertDialog.this,
                            mRightBtn);
                }
        ...
        mSingleBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mBuilder.getSingleListener() != null) {
                    ...
                    mBuilder.getSingleListener().clickSingleButton(AlertDialog.this,
                            mSingleBtn);
                }
            }
        });
    ...
    public static class Builder {
        ...
        private DialogInterface.OnLeftAndRightClickListener<AlertDialog> onclickListener;
        private DialogInterface.OnSingleClickListener<AlertDialog> singleListener;
        ...
        public DialogInterface.OnLeftAndRightClickListener<AlertDialog> getOnclickListener() {
            return onclickListener;
        }

        public Builder setOnclickListener(DialogInterface.OnLeftAndRightClickListener<AlertDialog> onclickListener) {
            this.onclickListener = onclickListener;
            return this;
        }

        public DialogInterface.OnSingleClickListener<AlertDialog> getSingleListener() {
            return singleListener;
        }

        public Builder setSingleListener(DialogInterface.OnSingleClickListener<AlertDialog>
                                                 singleListener) {
