 ...
 */
public class WeixinTishiDialog1 {
    ...
    public WeixinTishiDialog1(Builder builder) {

        this.mBuilder = builder;
        mDialog = new Dialog(mBuilder.getContext(), R.style.NormalDialogStyle);
        mDialogView = View.inflate(mBuilder.getContext(), R.layout.weixin_tishi_dialog1, null);
...
//        mDialog.setCanceledOnTouchOutside(builder.isTouchOutside());
        ...
        dialog_normal_rightbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mBuilder.getOnclickListener() != null) {
                    ...
                    mBuilder.getOnclickListener().clickRightButton(WeixinTishiDialog1.this,
        ...
        dialog_normal_leftbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mBuilder.getOnclickListener() != null) {
                    ...
                    mBuilder.getOnclickListener().clickLeftButton(WeixinTishiDialog1.this,
    ...
    public static class Builder {
        ...
        private DialogInterface.OnLeftAndRightClickListener<WeixinTishiDialog1> onclickListener;
        private DialogInterface.OnSingleClickListener<WeixinTishiDialog1> singleListener;
        ...
        public DialogInterface.OnSingleClickListener<WeixinTishiDialog1> getSingleListener() {
            return singleListener;
        }

        public Builder setSingleListener(DialogInterface.OnSingleClickListener<WeixinTishiDialog1>
                                                 singleListener) {
            this.singleListener = singleListener;
            return this;
        }

        public DialogInterface.OnLeftAndRightClickListener<WeixinTishiDialog1> getOnclickListener() {
            return onclickListener;
        }

        public Builder setOnclickListener(DialogInterface.OnLeftAndRightClickListener<WeixinTishiDialog1>
                                                  onclickListener) {
        ...
        public WeixinTishiDialog1 build() {

            return new WeixinTishiDialog1(this);
        }
    }
